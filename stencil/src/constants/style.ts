...
export const text = (tag, type, color, min, val, max, multiplier, weight, letterSpacing, lineHeight, transform, global = false) => ({
  ...
  letterSpacing: setVar(tag, '' + type + '-letter-spacing', letterSpacing, global),
