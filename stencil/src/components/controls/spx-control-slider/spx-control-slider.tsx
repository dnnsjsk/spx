...
@Component({
  tag: 'spx-control-slider',
  shadow: true,
})
export class SpxControlSlider {
  // eslint-disable-next-line no-undef
  @Element() el: HTMLSpxControlSliderElement;
  ...
  render() {
    ...
    const style = tw(
      css({
        'div.noUi-target': {
          '@apply':
            'h-1.5 mt-1.5 shadow-none bg-blue-gray-100 rounded-full border-none',
        },
        'div.noUi-connects': {
        ...
        'div.noUi-horizontal .noUi-handle': {
          '@apply':
            'focus-out shadow-none rounded-full border-blue-gray-300 h-6 w-6',
          top: '-9px',
          '&:before, &:after': {
            display: 'none',
          },
    ...
    return (
      <div class={base + ' ' + style}>
        <div class={tw(`flex justify-between`)}>
          ...
          <spx-control-label label={String(this.value)} mb={true} />
        </div>
