    ...
    render () {
      const styleText = {
        '[slot="pre-title"]:not(.spx)': {
          ...s.text(tag, 'pre-title', this.preTitleColor, '16px', '1.8vw', '24px', this.preTitleFontSizeMultiplier, this.preTitleFontWeight, this.preTitleLetterSpacing, this.preTitleLineHeight, this.preTitleTextTransform),
        ...
        'h1:not(.spx), h1 span:not(.spx), h2:not(.spx), h2 span:not(.spx)': {
          ...s.text(tag, 'title', this.titleColor, '32px', '5vw', '80px', this.titleFontSizeMultiplier, this.titleFontWeight, this.titleLetterSpacing, this.titleLineHeight, this.titleTextTransform),
        ...
        'p:not(.spx), [data-spx-tabs-header]:not(.spx)': {
          ...s.text(tag, 'text', this.textColor, '18px', '2vw', '32px', this.textFontSizeMultiplier, this.textFontWeight, this.textLetterSpacing, this.textLineHeight, this.textTransform),
          background: 'none',
      ...
      const styleBase = {
        ...
        'spx-section-text-media': {
          ...
          '&[type="tabs"]': {
            '& > div:first-of-type': {
              ...c.spaceScale(setVar(tag, 'space-unit', 'clamp(0.8em, 1.4vw, 2em)'))
            },
