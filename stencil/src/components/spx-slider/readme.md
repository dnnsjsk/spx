...
| `maxHeight`                          | `max-height`                            |                                                          | `string`  | `'none'`                          |
...
| `pagination`                         | `pagination`                            | Pagination type.                                         | `string`  | `undefined`                       |
...
| `paginationBulletsDynamicAmount`     | `pagination-bullets-dynamic-amount`     | Amount of dynamic bullets.                               | `number`  | `undefined`                       |
| `paginationBulletsSize`              | `pagination-bullets-size`               | Size of the bullets.                                     | `string`  | `'8px'`                           |
| `paginationBulletsSpaceBetween`      | `pagination-bullets-space-between`      | Space between the bullets.                               | `string`  | `'5px'`                           |
