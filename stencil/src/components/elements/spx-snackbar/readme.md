...
| `buttonBackground`               | `button-background`                 |                                                       | `string`                                          | `'var(--spx-color-gray-700)'` |
| `buttonBackgroundHover`          | `button-background-hover`           |                                                       | `string`                                          | `'var(--spx-color-gray-800)'` |
| `buttonTransitionDuration`       | `button-transition-duration`        |                                                       | `string`                                          | `s.transitionDuration`        |
| `buttonTransitionTimingFunction` | `button-transition-timing-function` |                                                       | `string`                                          | `s.transitionTimingFunction`  |
