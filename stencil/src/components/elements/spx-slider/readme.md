...
| `navigationBackdropFilter`           | `navigation-backdrop-filter`            |                                                           | `string`  | `s.backdropFilter`            |
...
| `paginationBackdropFilter`           | `pagination-backdrop-filter`            |                                                           | `string`  | `s.backdropFilter`            |
...
| `paginationBulletsSpaceBetween`      | `pagination-bullets-space-between`      | Space between the bullets.                                | `string`  | `'6px'`                       |
