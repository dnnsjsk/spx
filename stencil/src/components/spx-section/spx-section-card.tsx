...
export class SpxSectionCard {
    ...
    @Prop({ reflect: true }) boxShadow: string = '0px 2px 10px 0px rgba(0, 0, 0, 0.1)'
    ...
    render () {
      ...
      const styleBase = {
        ...
        h3: {
          ...c.text(tag, 'title', this.titleColor, '16px', '4vw', '24px', this.titleFontSizeMultiplier, this.titleFontWeight, this.titleLetterSpacing, this.titleLineHeight, this.titleTextTransform),
          display: 'inline-block',
          maxWidth: 'max-content'
        },

        p: {
          ...c.text(tag, 'text', this.textColor, '14px', '3vw', '18px', this.textFontSizeMultiplier, this.textFontWeight, this.textLetterSpacing, this.textLineHeight, this.textTransform),
          display: 'inline-block',
          maxWidth: 'max-content',
