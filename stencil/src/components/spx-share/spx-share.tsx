...
import { Component, h, Host, Element, Prop, State, Method } from '@stencil/core'
...
export class SpxShare {
    ...
    render () {
      ...
      const styleFacebook = css({
        background:
                this.theme === 'default' && !this.itemBackground ? '#1877F2'
                  : this.theme === 'default' && this.itemBackground ? this.itemBackground : null,
        color:
      ...
      const styleTwitter = css({
        background:
                this.theme === 'default' && !this.itemBackground ? '#1DA1F2'
                  : this.theme === 'default' && this.itemBackground ? this.itemBackground : null,
        color:
      ...
      const styleEmail = css({
        background:
                this.theme === 'default' && !this.itemBackground ? '#c6c6c6'
                  : this.theme === 'default' && this.itemBackground ? this.itemBackground : null,
      ...
      const styleWhatsapp = css({
        background:
                this.theme === 'default' && !this.itemBackground ? '#25D366'
                  : this.theme === 'default' && this.itemBackground ? this.itemBackground : null,
      ...
      return <Host class={styleHost}>
        ...
        <a class={css([styleLink, styleFacebook])} target={this.target}
        ...
        <a class={css([styleLink, styleTwitter])} target={this.target}
        ...
        <a class={css([styleLink, styleWhatsapp])} target={this.target}
        ...
        <a class={css([styleLink, styleEmail])} target={this.target}
