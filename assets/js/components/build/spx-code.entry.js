 ...
 */
const intersectionObserver = (el, functionToRun) => {
...
const SpxCode = class {
  ...
  render() {
    ...
    const styleHost = css({
      ...
      pre: {
        ...
        '.line-numbers-rows': {
          ...
          background: setVar(tag, 'line-numbers-background', this.lineNumbersBackground),
          '& > span:before': {
    ...
    const styleClipboard = css({
      ...
      top: 0,
      cursor: 'pointer',
      textTransform: setVar(tag, 'clipboard-button-text-transform', this.clipboardButtonTextTransform),
      background: setVar(tag, 'clipboard-button-background', this.clipboardButtonBackground),
      color: setVar(tag, 'clipboard-button-color', this.clipboardButtonColor),
      padding: setVar(tag, 'clipboard-button-padding', this.clipboardButtonPadding),
      fontSize: setVar(tag, 'clipboard-button-font-size', this.clipboardButtonFontSize),
      fontWeight: setVar(tag, 'clipboard-button-font-weight', this.clipboardButtonFontWeight),
    ...
    return (h(Host, { class: styleHost }, h("pre", { "data-start": this.lineNumbers && this.lineNumbersStart, class: this.lineNumbers && 'line-numbers' }, h("code", { ref: (el) => (this.code = el), class: 'language-' + this.type }, h("slot", null))), this.clipboard && (h("button", { ref: (el) => (this.clipboardButton = el), class: styleClipboard, onClick: this.onClickClipboard }, this.clipboardButtonText))));
  }
  get el() { return getElement(this); }
};
SpxCode.style = {
  default: spxCodeDefaultCss,
  dracula: spxCodeDraculaCss
};

export { SpxCode as spx_code };
