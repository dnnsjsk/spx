import { r as registerInstance, e as createEvent, h as h$1, f as Host, g as getElement } from './index-889edf71.js';
...
const SpxNotation = class {
  constructor(hostRef) {
    ...
    this.color = 'var(--spx-color-secondary-100)';
  ...
  annotate() {
    this.annotation = _(this.el.querySelector('span > *'), {
  ...
  render() {
    ...
    return (h$1(Host, { class: styleHost }, h$1("span", null, h$1("slot", null))));
  }
