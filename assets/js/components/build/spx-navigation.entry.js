...
import { c as borderRadius, t as transitionDuration, a as transitionTimingFunction, e as bpMobileWidth, b as fontFamily } from './style-54a0be1c.js';
...
const SpxNavigation = class {
  constructor(hostRef) {
     ...
     * @CSS
     */
    this.childBorderRadius = borderRadius;
    /**
  ...
  renderMenu(obj, type, mobile) {
    ...
    return (h("div", { class: checkMobile() }, h("ul", null, Object.values(obj).map((object) => {
      const objectChild = object['spxChildren'];
      const extraClasses = object['classes']
        .map((objectClasses) => objectClasses)
        .toString()
        .replace(/,/g, '  ');
      return (h("li", { class: object['spxChildren']
          ? /** Check if menu has any children. */
            'spx-navigation__item--' +
              ...
              extraClasses
          : 'spx-navigation__item--' + type + '' + ' ' + extraClasses, "data-order": object['menu_order'] }, h("a", { href: object['url'] === '#' ? '#0' : object['url'] }, object['title'], objectChild &&
        !this.mobileBp &&
        !this.vertical &&
        this.childIcon && (h("spx-icon", { type: this.childIconType, icon: this.childIcon }))), objectChild &&
        !mobile &&
    ...
    if (!this.vertical) {
      ...
      if (parentMenu) {
        parentMenu.forEach((item) => {
          createPopper$2(item, item.querySelector('div'), {
            // @ts-ignore
  ...
  initPopperMobile() {
    ...
    if (mobileMenu) {
      createPopper$2(mobileMenu, mobileMenu.querySelector('.spx-navigation--mobile'), {
        // @ts-ignore
  ...
  render() {
      ...
      ul: {
        ...
        ul: {
          ...
          marginLeft: (this.mobileBp || this.vertical) &&
            setVar(tag, 'mobile-item-nested-margin-left', this.mobileItemNestedMarginLeft),
        },
      },
        ...
        '&.spx-navigation__item--has-child > .spx-navigation--child': {
          ...
          a: {
            ...
            '&:hover': {
              ...
              background: !this.mobileBp &&
                setVar(tag, 'child-item-color-background-hover', this.childItemBackgroundHover),
            },
          },
          '::before': {
            content: '" "',
    ...
    return (h("nav", { class: styleHost }, this.menu /** Render desktop menu. */ && [
      this.renderMenu(this.menuArray, 'parent', false),
      /** Render mobile menu. */
      h("div", { tabindex: "0", role: "button", class: "spx-navigation__mobile-button" }, this.mobileIcon && (h("spx-icon", { type: this.mobileIconType, icon: this.mobileIcon })), h("span", null, "Menu"), this.renderMenu(this.menuArray, 'parent', true)),
    ]));
  }
...
export { SpxNavigation as spx_navigation };
