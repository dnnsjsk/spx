...
import { k as keyframes, c as css$1 } from './emotion-css.esm-4fec7074.js';
import { s as setVar } from './setVar-20b48ccd.js';
import { a as setClamp } from './setVarOrClamp-21aa6296.js';
import { c as borderRadius, t as transitionDuration, a as transitionTimingFunction } from './style-54a0be1c.js';
import { g as globalComponentDidLoad } from './globalComponentDidLoad-19b7147f.js';
import { s as startsWith, f as fromPairs, a as mapKeys, c as camelCase } from './lodash-4338c591.js';
...
const SpxScrollspy = class {
  constructor(hostRef) {
     ...
     * @CSS
     */
    this.paginationBulletsSize = '8px';
    /**
     * Space between the bullets.
     * @CSS
     */
    this.paginationBulletsSpaceBetween = '4px';
    this.paginationTabsGapMin = 1;
    this.paginationTabsGapMax = 1.8;
    this.paginationTabsMarginBottomMin = 1.4;
    this.paginationTabsMarginBottomMax = 2.6;
    this.paginationTabsMaxWidth = '320px';
    this.paginationTabsInnerGapMin = 0.8;
    this.paginationTabsInnerGapMax = 1;
    this.paginationTabsPaddingMin = 1;
  ...
  createTabs() {
    ...
    slides.forEach((item, index) => {
      ...
      slide.classList.add(css$1({
        padding: setClamp(tag, 'pagination-tabs-padding', this.paginationTabsPaddingMin, this.paginationTabsPaddingMax) +
          ' ' +
          setClamp(tag, 'pagination-tabs-padding', this.paginationTabsPaddingMin, this.paginationTabsPaddingMax) +
          ' ' +
          setClamp(tag, 'pagination-tabs-padding', this.paginationTabsPaddingMin * 2, this.paginationTabsPaddingMax * 2) +
          ' ' +
          setClamp(tag, 'pagination-tabs-padding', this.paginationTabsPaddingMin, this.paginationTabsPaddingMax),
        ...
        'span:nth-child(2)': {
          marginTop: setClamp(tag, 'pagination-tabs-inner-gap', this.paginationTabsInnerGapMin, this.paginationTabsInnerGapMax),
        },
  ...
  render() {
    ...
    const styleHost = css$1({
      ...
      img: {
        width: '100%',
        height: 'auto',
        objectFit: setVar(tag, 'image-object-fit', this.imageObjectFit),
      },
    });
    /** Pagination styles. */
    const stylePagination = css$1({
      display: 'flex',
      alignItems: 'center',
      marginBottom: setClamp(tag, 'pagination-tabs-margin-bottom', this.paginationTabsMarginBottomMin, this.paginationTabsMarginBottomMax),
    });
    /** Tab styles. */
    const stylePaginationTabs = css$1({
      ...
      gridGap: setClamp(tag, 'pagination-tabs-gap', this.paginationTabsGapMin, this.paginationTabsGapMax),
    });
    /** Bullet styles. */
    const stylePaginationBullets = css$1({
      ...
      height: this.direction === 'horizontal'
        ? setVar(tag, 'pagination-bullets-size', this.paginationBulletsSize) +
          ' !important'
        : 'auto' + ' !important',
      width: this.direction === 'vertical'
        ? setVar(tag, 'pagination-bullets-size', this.paginationBulletsSize) +
          ' !important'
        : '100%' + ' !important',
    ...
    return (h(Host, { class: styleHost }, this.pagination === 'tabs' && (h("div", { class: stylePagination }, h("div", { ref: (el) => (this.paginationTabs = el), class: stylePaginationTabs }))), h("div", { ref: (el) => (this.container = el), class: "swiper-container" }, h("div", { class: "swiper-wrapper" }, getGallery(this.images, this.imagesSrc, this.imagesArray, this.imageSize)), this.pagination === 'bullets' && (h("div", { class: stylePaginationBullets + ' ' + 'swiper-pagination', ref: (el) => (this.paginationBullets = el) })), h("div", { class: styleNavigation }, h("div", { ref: (el) => (this.prev = el), class: styleNavigationPrev }, h("spx-icon", { type: this.navigationIconType, icon: this.navigationIconPrev, color: setVar(tag, 'navigation-color', this.navigationColor), size: setVar(tag, 'navigation-size', this.navigationSize) })), h("div", { ref: (el) => (this.next = el), class: styleNavigationNext }, h("spx-icon", { type: this.navigationIconType, icon: this.navigationIconNext, color: setVar(tag, 'navigation-color', this.navigationColor), size: setVar(tag, 'navigation-size', this.navigationSize) })))), h("slot", { name: "gallery" })));
  }
...
SpxScrollspy.style = spxSliderCss;

export { SpxScrollspy as spx_slider };
