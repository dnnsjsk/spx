...
const SpxControlNumber = class {
  ...
  render() {
    ...
    const base = `
      ...
      'div.noUi-target': {
          '@apply':
            'h-1.5 mt-2 shadow-none bg-blue-gray-100 rounded-full border-none',
        },
        'div.noUi-connects': {
        ...
        'div.noUi-horizontal .noUi-handle': {
          '@apply': 'focus-out shadow-none rounded-full border-blue-gray-300',
          top: '-10px',
          '&:before, &:after': {
    ...
    `;
    return (h(Host, null, h("div", { class: "label" }, h("spx-control-label", { label: this.label, mb: true }), this.slider && h("spx-control-label", { label: this.value, mb: true })), this.slider && (h("div", { ref: (el) => (this.container = el) })), h("spx-control-input", { style: { display: this.slider ? 'none' : 'block' }, data: this.data, handleInput: this.onInput, max: !this.slider && this.max, min: !this.slider && this.min, ref: (el) => (this.input = el), step: !this.slider && this.step, type: this.slider ? 'text' : 'number', value: this.value })));
  }
...
SpxControlNumber.style = spxControlNumberCss;

export { SpxControlNumber as spx_control_number };
