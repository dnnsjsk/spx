...
const SpxCode = class {
  ...
  render() {
    return (h("div", { class: "inner" }, h("pre", { tabindex: "-1", class: this.lineNumbers && 'line-numbers' }, h("code", { tabindex: "-1", class: 'language-' + this.type, innerHTML: sanitize(this.contentInner) })), this.clipboard && (h(Button, { as: "button", class: "clipboard", ref: (el) => (this.clipboardButton = el), onClick: this.onClickClipboard, onEnter: this.onClickClipboard }, this.clipboardButtonText))));
  }
