...
const SpxScrollspy = class {
  ...
  render() {
    return (h("div", { class: "inner" }, h("div", { ref: (el) => (this.swiperContainer = el), class: "swiper-container" }, helperImagesOrInner({
    ...
    }), h("div", { class: 'pagination swiper-pagination ' +
        (this.paginationBulletsDynamic
          ? 'swiper-pagination-bullets swiper-pagination-bullets-dynamic'
          : 'swiper-pagination-bullets'), ref: (el) => (this.paginationBullets = el) }), h("div", { class: "navigation" }, h(Button, { ref: (el) => (this.prev = el), class: "navigation__prev" }, h("spx-icon", { type: this.navigationIconType, icon: this.navigationIconPrev })), h(Button, { ref: (el) => (this.next = el), class: "navigation__next" }, h("spx-icon", { type: this.navigationIconType, icon: this.navigationIconNext }))))));
  }
