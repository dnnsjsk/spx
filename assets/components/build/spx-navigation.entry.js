...
const SpxNavigation = class {
  constructor(hostRef) {
      ...
      return (h("div", { class: checkMobile() }, h("ul", null, Object.values(obj).map((object) => {
        ...
        return (h("li", { class: object['spxChildren']
            ? 'item--' +
              ...
              'item--has-child' +
              extraClasses
            : 'item--' + type + '' + ' ' + extraClasses, "data-order": object['menu_order'] }, h(Button, { href: object['url'] === '#' ? '#0' : object['url'] }, object['title'], objectChild &&
          !this.isMobile &&
          !this.vertical &&
    ...
    this.renderNav = () => {
      return (this.menu && [
        ...
        h("div", { tabindex: "0", role: "button", class: "mobile__button" }, this.mobileIcon && (h("spx-icon", { type: this.mobileIconType, icon: this.mobileIcon })), h("span", null, "Menu"), this.renderMenu(this.menuArray, 'parent', true)),
      ]);
    };
  }
  ...
  render() {
    return h("nav", null, this.renderNav());
  }
...
SpxNavigation.style = spxNavigationCss;
