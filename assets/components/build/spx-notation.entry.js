import { r as registerInstance, e as createEvent, h as h$1, j as Host, g as getElement } from './index-a2b24666.js';
...
const SpxNotation = class {
  ...
  render() {
    return (h$1(Host, null, isInShadow(this.el) && h$1("style", null, this.keyframes), this.group ? (h$1("slot", null)) : (h$1("span", null, h$1("span", null, h$1("slot", null))))));
  }
  get el() { return getElement(this); }
};
SpxNotation.style = spxNotationCss;

export { SpxNotation as spx_notation };
